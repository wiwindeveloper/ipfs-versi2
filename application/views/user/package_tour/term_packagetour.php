            ...
            <div class="term-condition">
                ...
                <form class="user" method="post" action="#">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="p-5">
                            <a class="btn btn-ok btn-block wd-px text-uppercase" id="btnBuy" href="#" data-toggle="modal" data-target="#notificationModal"><?= $this->lang->line('buy'); ?></a>
                        </div>
                        <div class="p-5">
                            ...
                            <a href="<?= base_url('user/packageTour'); ?>" class="btn btn-cancel btn-block wd-px text-uppercase" data-toggle="modal" data-target="#cancelModal">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-secondary text-uppercase" type="button" data-dismiss="modal"><?= $this->lang->line('cancel'); ?></button>
                                    <button type="submit" name="buy" class="btn btn-ok btn-block wd-px text-uppercase" id="btnBuy">
                                    <?= $this->lang->line('ok'); ?>
                                    </button>
                                </div>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?= base_url('user/packageTour'); ?>"><?= $this->lang->line('ok');?></a>
            </div>
        </div>
    </div>
</div>