    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 mx-auto justify-content-center text-justify">
                ...
                <p class="text-center text-white mb-1 text-uppercase" style="font-size:24px; font-weight:800;">VIP <?= $this->lang->line('gold_bali_title'); ?> + NYEPI</p>
                <table border="1" cellpadding="4" class="tb-tour font-italic mx-auto w-100 text-uppercase">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th rowspan="8" class="text-center"><?= $this->lang->line('day'); ?> 2</th>
                            <td class="text-center">06.30</td>
                            <td><?= $this->lang->line('golf_tour'); ?></td>
                        ...
                        <tr>
                            <th rowspan="6" class="text-center"><?= $this->lang->line('day'); ?> 4 KUTA TOUR</th>
                            <td class="text-center">12.00</td>
                            <td><?= $this->lang->line('restaurant'); ?></td>
                            <td><?= $this->lang->line('lunch'); ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>HIP HOP & <?= $this->lang->line('dinner'); ?></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td class="text-center">21.00</td>
                        ...
                        <tr>
                            <th rowspan="6" class="text-center"><?= $this->lang->line('day'); ?> 5</th>
                        ...
                        <tr>
                            ...
                            <td><?= $this->lang->line('foot_massage'); ?></td>
                            <td><?= $this->lang->line('massage'); ?></td>
                        </tr>
                        <tr>
                            <td class="text-center">16.00</td>
                            <td><?= $this->lang->line('hotel'); ?></td>
                            <td><?= $this->lang->line('free_time'); ?></td>
                        </tr>
                        <tr>
                            <td class="text-center">18.30</td>
                            <td><?= $this->lang->line('dinner'); ?> AND ZPOP</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td class="text-center">21.00</td>
                        ...
                        <tr>
                            <th rowspan="10" class="text-center"><?= $this->lang->line('day'); ?> 6</th>
