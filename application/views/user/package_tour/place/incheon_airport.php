...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-white my-home-title"><?= $this->lang->line('package_purchase'); ?></h1>
    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 text-white mx-auto justify-content-center text-justify">
                ...
                <h2 class="font-italic font-weight-bold"><?= $this->lang->line('incheon_airport'); ?></h2>
                <p><?= $this->lang->line('incheon_airport_paragraph1'); ?></p>
                <p><?= $this->lang->line('incheon_airport_paragraph2'); ?></p>
                <p><?= $this->lang->line('incheon_airport_paragraph3'); ?></p>
                <p><?= $this->lang->line('incheon_airport_paragraph4'); ?></p>
