    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 text-white mx-auto justify-content-center text-justify">
                ...
                <h2 class="font-italic font-weight-bold text-uppercase">TEGALALANG RICE TERRACE</h2>
               <p><?= $this->lang->line('tegalalang_rice_paragraph1'); ?></p>
               <p><?= $this->lang->line('tegalalang_rice_paragraph2'); ?></p>
               <p><?= $this->lang->line('tegalalang_rice_paragraph3'); ?></p>
               <p><?= $this->lang->line('tegalalang_rice_paragraph4'); ?></p>
            </div>
        </div>
    </div>
