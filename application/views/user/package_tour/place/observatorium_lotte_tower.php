    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 text-white mx-auto justify-content-center text-justify">
                ...
                <h2 class="font-italic font-weight-bold"><?= $this->lang->line('observatorium_lotte_tower'); ?></h2>
                <p><?= $this->lang->line('lotte_tower_paragraph1'); ?></p>
                <p><?= $this->lang->line('lotte_tower_paragraph2'); ?></p>
                <p><?= $this->lang->line('lotte_tower_paragraph3'); ?></p>
                <p><?= $this->lang->line('lotte_tower_paragraph4'); ?></p>
            </div>
        </div>
    </div>
