    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 text-white mx-auto justify-content-center text-justify">
                <img src="<?= base_url('assets/photo/tour/ngurahrai_airport.jpg'); ?>" alt="Gyeongbok Palace" class="mb-4 img-placetour">
                <h2 class="font-italic font-weight-bold">NGURAH RAI AIRPORT</h2>
                <p><?= $this->lang->line('ngurahrai_airport_paragraph1'); ?></p>
                <p><?= $this->lang->line('ngurahrai_airport_paragraph2'); ?></p>
                <p><?= $this->lang->line('ngurahrai_airport_paragraph3'); ?></p>
            </div>
        </div>
    </div>
