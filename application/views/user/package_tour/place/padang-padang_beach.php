    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 text-white mx-auto justify-content-center text-justify">
               ...
               <p><?= $this->lang->line('padang_padang_paragraph1'); ?></p>
               <p><?= $this->lang->line('padang_padang_paragraph2'); ?></p>
               <p><?= $this->lang->line('padang_padang_paragraph3'); ?></p>
               <p><?= $this->lang->line('padang_padang_paragraph4'); ?></p>
            </div>
        </div>
    </div>
