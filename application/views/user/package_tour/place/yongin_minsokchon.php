    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 text-white mx-auto justify-content-center text-justify">
                ...
                <h2 class="font-italic font-weight-bold text-uppercase"><?= $this->lang->line('yongin_misokchon'); ?></h2>
                <p><?= $this->lang->line('yongin_misokchon_paragraph1'); ?></p>
                <p><?= $this->lang->line('yongin_misokchon_paragraph2'); ?></p>
                <p><?= $this->lang->line('yongin_misokchon_paragraph3'); ?></p>
                <p><?= $this->lang->line('yongin_misokchon_paragraph4'); ?></p>
            </div>
        </div>
    </div>
