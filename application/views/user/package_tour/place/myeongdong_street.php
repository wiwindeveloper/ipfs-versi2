    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 text-white mx-auto justify-content-center text-justify">
                ...
                <h2 class="font-italic font-weight-bold text-uppercase"><?= $this->lang->line('myeongdong_street'); ?></h2>
                <p><?= $this->lang->line('myeongdong_street_paragraph1'); ?></p>
                <p><?= $this->lang->line('myeongdong_street_paragraph2'); ?></p>
                <p><?= $this->lang->line('myeongdong_street_paragraph3'); ?></p>
                <p><?= $this->lang->line('myeongdong_street_paragraph4'); ?></p>
                <p><?= $this->lang->line('myeongdong_street_paragraph5'); ?></p>
            </div>
        </div>
    </div>
