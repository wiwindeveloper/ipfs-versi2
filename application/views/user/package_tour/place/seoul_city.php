    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 text-white mx-auto justify-content-center text-justify">
                <img src="<?= base_url('assets/photo/tour/seoul.jpg'); ?>" alt="Seoul City" class="mb-4 img-placetour">
                <h2 class="font-italic font-weight-bold text-uppercase"><?= $this->lang->line('seoul_city'); ?></h2>
                <p><?= $this->lang->line('seoul_paragraph1'); ?></p>
                <p><?= $this->lang->line('seoul_paragraph2'); ?></p>
                <p><?= $this->lang->line('seoul_paragraph3'); ?></p>
                <p>
                    <?= $this->lang->line('seoul_paragraph4'); ?>
                </p>
            </div>
        </div>
    </div>
