    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 text-white mx-auto justify-content-center text-justify">
                ...
                <h2 class="font-italic font-weight-bold text-uppercase"><?= $this->lang->line('single_fin'); ?></h2>
                <p><?= $this->lang->line('single_fin_paragraph1'); ?></p>
                <p><?= $this->lang->line('single_fin_paragraph2'); ?></p>
                <p><?= $this->lang->line('single_fin_paragraph3'); ?></p>
            </div>
        </div>
    </div>
