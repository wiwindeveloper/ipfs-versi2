...
<div class="container-fluid">
    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 mx-auto justify-content-center text-justify">
                <p class="font-italic text-center mb-0 text-uppercase" style="color:#c49a6c; font-size:40px; font-weight:800; margin-top:-75px; text-shadow: 4px 3px 10px black;"><?= $this->lang->line('gold_vvip_intinerary');?></p>
                <p class="text-center text-white mb-1 text-uppercase" style="font-size:24px; font-weight:800;">VIP <?= $this->lang->line('gold_korea_title');?></p>
                <table border="1" cellpadding="4" class="tb-tour font-italic mx-auto w-100 text-uppercase">
                    ...
                    <tr>
                        ...
                        <td><a href="<?= base_url('user/incheonAirport'); ?>" onmouseover=" showLinkPreview()" onmouseleave="hideLinkPreview()" class="link-with-preview text-dark pt-2" data-image="<?= base_url('assets/photo/tour/incheon-airport.jpg'); ?>" data-title="<?= $this->lang->line('incheon_airport'); ?>" data-text="<?= $this->lang->line('data_text_incheon_airport'); ?>"><?= $this->lang->line('incheon_airport'); ?></a></td>
                    ...
                    <tr>
                        <td class="text-center">18.00</td>
                        <td><a href="<?= base_url('user/namiIsland'); ?>" onmouseover=" showLinkPreview()" onmouseleave="hideLinkPreview()" class="link-with-preview text-dark pt-2" data-image="<?= base_url('assets/photo/tour/nami-island.jpg'); ?>" data-title="<?= $this->lang->line('nami_island'); ?>" data-text="<?= $this->lang->line('data_text_nami_island'); ?>"><?= $this->lang->line('nami_island'); ?></a></td>
                        <td><?= $this->lang->line('tour_dinner'); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="text-center">13.00</td>
                        <td><a href="<?= base_url('user/lotteWorld'); ?>" onmouseover=" showLinkPreview()" onmouseleave="hideLinkPreview()" class="link-with-preview text-dark pt-2" data-image="<?= base_url('assets/photo/tour/lotte-world.jpg'); ?>" data-title="<?= $this->lang->line('lotte_world'); ?>" data-text="<?= $this->lang->line('data_text_lotte_world'); ?>"><?= $this->lang->line('lotte_world'); ?></a></td>
                        <td><?= $this->lang->line('tour'); ?></td>
                    </tr>
                    <tr>
                        <td class="text-center">18.00</td>
    ...
    <div class="my-4 mx-auto w-50">
        <a href="<?= base_url() . 'user/tour/3' ?>" class="btn btn-bonus btn-block font-italic"><?= $this->lang->line('buy'); ?></a>
    </div>
