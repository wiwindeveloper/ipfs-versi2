...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-white my-home-title text-uppercase">KRP <?= $this->lang->line('wallet'); ?> </h1>
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade <?= empty($uriSegment) ? 'show active' : ''; ?>" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-2 mx-auto my-2">
                                    <img class="img-balance d-block d-lg-inline mx-auto" src="<?= base_url('assets/img/krp_logo.png') ?>" alt="img" width="100px">
                                </div>
                                ...
                                <div class="col-lg-8 d-flex justify-content-end my-2 px-0">
                                    <div class="mr-3 wrapper-excess-krp">
                                        <div class="text-balance font-weight-bold text-white text-uppercase mb-1 ">
                                            KRP <?= $this->lang->line('excess_bonus');?>
                                        </div>
                                        <h2 class="amount-balance"><?= number_format($excess_bonus['krp'], 10, ',', '.'); ?></h2>
                                        <div class="dollar-balance h5 mb-0 text-tb-head font-w-8">
                                            <i class="fas fa-dollar-sign"></i> <?= $market_price['krp'] * $excess_bonus['krp'] ?>
                                        </div>
                                    </div>
                                    <div class="wrapper-balance-krp">
                                        <div class="text-balance font-weight-bold text-white text-uppercase mb-1 ">
                                            KRP <?= $this->lang->line('general_balance');?>
                                        </div>
                                        <h2 class="amount-balance"><?= number_format($general_balance_krp, 10, ',', '.'); ?></h2>
                                        <div class="dollar-balance h5 mb-0 text-tb-head font-w-8">
                ...
                <div class="col-xl-12 col-md-12 mb-4">
                    <a href="<?= base_url('user/withdrawal_krp'); ?>" class="btn btn-ok btn-block text-capitalize">
                                            ...
                                            <table class="table table-bordered text-white" id="dataTable" width="100%" cellspacing="0">
                                                    ...
                                                    <?php foreach ($purchase as $row_purchase) : ?>
                                                        <?php if ($row_purchase->krp != 0) : ?>
                                                            <tr>
                                                                ...
                                                                <td>- <?= number_format($row_purchase->krp, 10, ',', '.'); ?></td>
                                                            </tr>
                                                        <?php endif ?>
                                                    <?php endforeach ?>
                                                </tbody>
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th><?= number_format($general_balance_krp, 10, ',', '.'); ?></th>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
        ...
        <div class="tab-pane fade <?= $uriSegment == 'bonus' ? 'show active' : ''; ?>" id="contact" role="tabpanel" aria-labelledby="contact-tab">
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3 my-auto">
                                    <img class="img-balance" src="<?= base_url('assets/img/krp_logo.png') ?>" alt="img" width="100px">
                                </div>
                                <div class="col-9 text-right">
                                    <div class="text-balance font-weight-bold text-white text-uppercase mb-1 ">
                                        KRP <?= $this->lang->line('bonus_balance');?>
                                    </div>
                                    <h2 class="amount-balance"><?= number_format($balance, 10); ?></h2>
                                    <div class="dollar-balance h5 mb-0 text-tb-head font-w-8">
                                        <i class="fas fa-dollar-sign"></i> <?= $market_price['krp'] * $balance ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-md-12 mb-4">
                    <a href="<?= base_url('user/transfer_bonus_krp'); ?>" class="btn btn-info btn-block">
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            KRP <?= $this->lang->line('income_from');?> <?= $row_list->username; ?>
                                                                        </td>
                                                                        <td><?= number_format($row_list->krp, 10); ?></td>
                                                                    </tr>
                                                                <?php
                                                            }
                                                        ?>
                                                        ...
                                                        if($row_list->krp != 0)
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    KRP <?= $this->lang->line('income_from');?> <?= $row_list->set_amount / 4; ?> set
                                                                </td>
                                                                <td><?= number_format($row_list->krp, 10); ?></td>
                                                            </tr>
                                                            <?php
