    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="term-condition">
                <h4 class="text-white text-center mb-3">Airdrops <?= $this->lang->line('balance');?></h4>
                <form method="post" action="<?php base_url('user/transfer_airdrops_zenx') ?>">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <a href="<?= base_url('user/walletzenxairdrop'); ?>" class="btn btn-cancel btn-user btn-block text-uppercase">
