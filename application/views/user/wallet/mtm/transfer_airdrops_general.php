    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="term-condition">
                <h4 class="text-white text-center mb-3">Air Drops <?= $this->lang->line('balance');?></h4>
                <form method="post" action="<?php base_url('user/transfer_airdrops_mtm') ?>">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <a href="<?= base_url('user/bonusList'); ?>" class="btn btn-cancel btn-user btn-block text-uppercase">
