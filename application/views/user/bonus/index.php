...
<div class="container-fluid">
    ...
    <div class="dropdown header-withmenu">
        <button class="btn btn-blue dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Airdrops/<?= $this->lang->line('mining'); ?>
        </button>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav navbar-menubonus">
                <li class="nav-item active">
                    <a class="nav-link" href="#">Airdrops/<?= $this->lang->line('mining'); ?></a>
                </li>
                <li class="nav-item">
    ...
    <!-- <div class="wrapper mb-3">
        <ul class="nav nav-menubonus justify-content-between align-items-center">
            <li class="nav-item pills-wallet">
                <a class="nav-link font-weight-bold d-flex justify-content-center align-items-center active" id="mtm-tab" data-toggle="tab" href="#mtm" role="tab" aria-controls="mtm" aria-selected="true">
                    <p class="mb-0">Airdrops/<?= $this->lang->line('mining'); ?></p>
                </a>
            </li>
            <li class="nav-item pills-wallet" role="presentation">
                <a class="nav-link font-weight-bold d-flex justify-content-center align-items-center" href="<?= base_url('user/sponsor'); ?>">
                    <p class="mb-0">&nbsp;<?= $this->lang->line('recommended'); ?></p>
                </a>
            </li>
            <li class="nav-item pills-wallet" role="presentation">
                <a class="nav-link font-weight-bold d-flex justify-content-center align-items-center" id="zenx-tab" data-toggle="tab" href="#zenx" role="tab" aria-controls="zenx" aria-selected="false">
                    <p class="mb-0">&nbsp; <?= $this->lang->line('recommended_matching'); ?></p>
                </a>
            </li>
            <li class="nav-item pills-wallet" role="presentation">
                <a class="nav-link font-weight-bold d-flex justify-content-center align-items-center" id="krp-tab" data-toggle="tab" href="#krp" role="tab" aria-controls="krp" aria-selected="false">
                    <p class="mb-0">&nbsp;<?= $this->lang->line('recommended_mining'); ?></p>
                </a>
            </li>
            <li class="nav-item pills-wallet" role="presentation">
                <a class="nav-link font-weight-bold d-flex justify-content-center align-items-center" id="usdt-tab" data-toggle="tab" href="#usdt" role="tab" aria-controls="usdt" aria-selected="false">
                    <p class="mb-0">&nbsp;<?= $this->lang->line('mining_generation'); ?></p>
                </a>
            </li>
            <li class="nav-item pills-wallet" role="presentation">
                <a class="nav-link font-weight-bold d-flex justify-content-center align-items-center" id="bumi-tab" data-toggle="tab" href="#bumi" role="tab" aria-controls="bumi" aria-selected="false">
                    <p class="mb-0">&nbsp;<?= $this->lang->line('pairing'); ?></p>
                </a>
            </li>
            <li class="nav-item pills-wallet" role="presentation">
                <a class="nav-link font-weight-bold d-flex justify-content-center align-items-center" id="bumi-tab" data-toggle="tab" href="#bumi" role="tab" aria-controls="bumi" aria-selected="false">
                    <p class="mb-0">&nbsp;<?= $this->lang->line('pairing_matching'); ?></p>
                </a>
            </li>
            <li class="nav-item pills-wallet" role="presentation">
                <a class="nav-link font-weight-bold d-flex justify-content-center align-items-center" id="bumi-tab" data-toggle="tab" href="#bumi" role="tab" aria-controls="bumi" aria-selected="false">
                    <p class="mb-0">&nbsp;<?= $this->lang->line('global'); ?></p>
                </a>
            </li>
            <li class="nav-item pills-wallet" role="presentation">
                <a class="nav-link font-weight-bold d-flex justify-content-center align-items-center" id="bumi-tab" data-toggle="tab" href="#bumi" role="tab" aria-controls="bumi" aria-selected="false">
                    <p class="mb-0">&nbsp;<?= $this->lang->line('basecamp'); ?></p>
                </a>
            </li>
        </ul>
    </div> -->
