...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-white my-home-title text-uppercase"><?= $this->lang->line('recommended'); ?></h1>
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-4 network-level">
            <div class="form-group form-inline">
                <label for="sel1" class="text-white mb-1"><?= $this->lang->line('type_limit_level'); ?>: &nbsp;</label>
                <input type="number" min="1" id="sel1" class="form-control" placeholder="<?= $this->lang->line('placehold_input_level'); ?> <?= $limitLevel;?>">
            </div>
        </div>
