...
$lang['bonus_sponsor_1'] = 'The bonus we get when we successfully invite someone directly for the first time join our team, and bonus what we get depends on how many boxes are taken by the team the first we invite to join for the percentage bonus is 5% up to 7%. And this sponsorship bonus is divided into 50% USDT and 50% KRP.';
$lang['bonus_calculation_as_follows'] = 'Bonus Calculations As Follows.';
$lang['bonus_sponsor_6'] = '<b>EXAMPLE : </b>You joined in one box and you also managed to invite your friends A and B and your friends take 1 box and 15 boxes so you get a bonus of 5% and 6% divided into 2 which is 50% USDT and 50% KRP depending on how many boxes your friends take';
$lang['img_bonus_sponsor'] = 'bonus_sponsor_en.png';
$lang['sponsor_matching_title'] = 'Matching Sponsor Bonus';
$lang['sponsor_matching_1'] = 'The bonus we get when the team we first recruit managed to get a new member under our network, and the bonuses we get are in the form of USDT and KRP.';
...
$lang['pairing_mining_1'] = 'Bonus given when you collect 1 set point below you from the left and right grid (4:4). the bonus in give following the terms and conditions of your rank and this bonus given in USDT.';
$lang['pairing_mining_2'] = 'Calculation Example';
$lang['set_box'] = 'set box';
$lang['set_boxes'] = 'set boxes';
$lang['pairing_mining_5'] = '<b>EXAMPLE : </b>You have successfully recruited A, C and D in the left grid with each join 3 Boxes and get 9 points and you succeed recruit B, E and F on the right grid with each joining 3 Box and get 9 points. You have met the requirements of Bonus Pairing Maining (9:9) means you will get 1 Set with 0.5 USDT Bonus and your remaining points will be accumulated daily';
...
$lang['pairing_matching_1'] = 'Bonuses that are obtained from the team below us directly who have managed to collect points (4:4) by recruiting the team directly below and the bonus you get follows the terms and conditions of your rank. This bonus is given in the form of USDT coins.';
$lang['pairing_matching_2'] = 'Bonus Calculations As Follows.';
$lang['pairing_matching_3'] = '<b>EXAMPLE : </b>You have an FM rating direct invites A and B, A and B managed to collect points and each got 1 set bonus (4:4) 0.5 USDT and you get each bonus by 20% of A and B';
$lang['img_pairing_matching'] = 'bonus_pairing_matching_en.png';
$lang['bonus_global_title'] = 'Global Bonus';
$lang['bonus_global_1'] = 'Global Bonus there is a bonus that we get from the turnover calculation global FILBOX.IO users worldwide with terms and conditions minimum rank FM4 to FM10, bonus is earned by calculation FIL but what is paid is USDT which is accumulated every month with certain calculations.';
$lang['bonus_global_2'] = 'Bonus Calculations As Follows.';
$lang['bonus_global_3'] = '<b>EXAMPLE : </b>this month the total turnover obtained is 1,000,000 FIL, you are on FM 4 you will get 2% of total turnover global mining 1,000,000 fills multiplied by 2% for you as FM 4. So that the calculation is 1,000,000 X 2% = 20,000 FIL later because of the bonus that given USDT so the calculation is 20,000 X 3 = 60,000 USDT. Will be share with some people who have reached FM 4 rating on the month. For example, this month there are 20 FM4 and there are also in it, it means the distribution is 60,000 USDT : 20 people = 3,000 USDT per each FM4';
