...
{
    protected $_ci;
    protected $sender_email = 'ipfs.asia1@gmail.com'; // Isikan dengan email pengirim
    protected $sender_name = 'ipfs. asia'; // Isikan dengan nama pengirim
    // protected $password = 'vssumbdrjgaxdvhd'; 
    protected $password = 'ygtohfmqfxdtqgox'; 
